import { Action, ActionName, Color, PolicyType, PrimitiveType, entityParent, webViewType, webviewOrientation } from "../endymion/endymion-v2.types";
import { BaseEntity } from "./en-base-entity";

export class EnWebview extends BaseEntity {
    type: PrimitiveType = 'webview';
    webViewParent!: entityParent;
    url: string = '';
    ...
    override setParent(webViewParent: entityParent): EnWebview {
