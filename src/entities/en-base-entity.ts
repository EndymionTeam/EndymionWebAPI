import { Color, Action, Entity, MessageName, MessagePayload, webViewParent, IncomingMessage } from "../endymion/endymion-v2.types";
...
export class BaseEntity {
    ...
    setParent(id: number | webViewParent ):void | BaseEntity{
        if(typeof id === 'number'){
            this.entity.parent = id;
        }
    }
}
